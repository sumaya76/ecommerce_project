...
<form method="post" action="store.php" enctype="multipart/form-data">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="promotional_message" value="" id="inputPromotional_message">
        </div>
    </div>
    <div class="mb-3 row">
        <label for="inputHTML_Banner" class="col-sm-2 col-form-label">HTML <br> Banner</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="hTML_Banner" value="" id="inputHTML_Banner">
        </div>
    </div>
