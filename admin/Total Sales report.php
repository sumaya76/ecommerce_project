...
if (isset($_GET['search']) || isset($_GET['date'])) {
    ...
    // Modify the SQL query to filter results based on search query and date
...
foreach ($orders as $order) {
    ...
    $total_cost = $order['quantity'] * $order['product_total_price']; // Total cost calculation
...
<body>
    <div class="container">
        <h2>Sales Report for <?php echo $date; ?></h2>
