...
<div class="container">
    <div class="row d-flex justify-content-center">
        <div class="col-sm-6 ">
            ...
            <ul class="nav d-flex justify-content-center fs-4 fw-bold mb-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-success" href="trash_index.php">All Trash Items</a>
                    </li>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="show.php?id=<?=$sponsers['id']?>">Show </a>|
      <a href="edit.php?id=<?=$sponsers['id']?>"> Edit</a> |
      <a href="trash.php?id=<?=$sponsers['id']?>">Trash</a></td>
